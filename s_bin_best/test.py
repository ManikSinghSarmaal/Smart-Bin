...
model_save_path = "/Users/maniksinghsarmaal/Downloads/s_bin/s_bin_best/pth_file/mobilenetv2_model.pth"
# Load the model
...
with torch.no_grad():
    # Make predictions
    output = loaded_model(preprocess_image("/Users/maniksinghsarmaal/Downloads/2.jpeg"))
