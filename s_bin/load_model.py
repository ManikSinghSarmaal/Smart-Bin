...
model_save_path = "/Users/maniksinghsarmaal/Downloads/s_bin/s_bin/pth file/mobilenetv2_model.pth"
# Load the model
...
class_labels = ["cardboard", "glass", "metal", "paper", "plastic", "trash"]  # labels

with torch.no_grad():
    # Make predictions
    output = loaded_model(preprocess_image(""))
